...
import com.zj.upms.client.shiro.session.UpmsSession;
import com.zj.upms.client.shiro.session.UpmsSessionDao;
import com.zj.upms.common.constant.UpmsResult;
...
public class SSOController extends BaseController {
    ...
    public String login(HttpServletRequest request) {
        ...
        // 判断是否已登录，如果已登录，则回跳
        String code = RedisUtil.get(FRAMEWORK_UPMS_SERVER_SESSION_ID + "_" + serverSessionId);
        // code校验值
    ...
    public Object login(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
        ...
        if (StringUtils.isBlank(hasCode)) {
            ...
            RedisUtil.lpush(FRAMEWORK_UPMS_SERVER_SESSION_IDS, sessionId.toString());
            // 默认验证帐号密码正确，创建code
    ...
    public Object code(HttpServletRequest request) {
        ...
        String code = RedisUtil.get(FRAMEWORK_UPMS_SERVER_CODE + "_" + codeParam);
