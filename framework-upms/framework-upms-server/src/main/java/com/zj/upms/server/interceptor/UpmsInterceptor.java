package com.zj.upms.server.interceptor;
...
public class UpmsInterceptor extends HandlerInterceptorAdapter {
    ...
    private static final String FRAMEWORK_OSS_ALIYUN_OSS_POLICY = PropertiesFileUtil.getInstance("framework-oss-client").get("framework.oss.aliyun.oss.policy");
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        request.setAttribute("FRAMEWORK_OSS_ALIYUN_OSS_POLICY", FRAMEWORK_OSS_ALIYUN_OSS_POLICY);
        // 过滤ajax
